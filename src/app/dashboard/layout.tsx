...
export default function DashboardLayout({
  ...
  return (
    <>
      <nav className="bg-white border-b border-gray-200 dark:bg-slate-900 dark:border-slate-700 fixed z-30 w-full">
      ...
      <div className="flex overflow-hidden bg-white dark:bg-slate-900 pt-16">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group  dark:bg-slate-900 dark:hover:bg-slate-600 dark:text-slate-300"
                      >
        ...
        >
          ...
          <footer className="bg-white dark:bg-slate-900 dark:opacity-90 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden">
